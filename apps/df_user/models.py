...
class UserInfo(models.Model):
    ...
    ucoupontimes = models.IntegerField(verbose_name="抽奖次数", default=10, max_length=1000)
    umoney = models.DecimalField(verbose_name="总消费额", default=0.0, max_digits=10, decimal_places=2, null=True)
